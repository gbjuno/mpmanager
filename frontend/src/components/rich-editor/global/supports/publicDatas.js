...
//export default {PRO_RELEASE, PRO_MENU, PRO_URL, PRO_USER, PRO_DOM_HELPER, PRO_REQUEST, PRO_COMMON, PRO_QINIU};
import PRO_BASE from './datas/base';
import PRO_URL from './datas/url';
import PRO_REQUEST from './methods/Request';
import PRO_COMMON from './methods/common';
import PRO_QINIU from './methods/public';

export { PRO_BASE, PRO_URL, PRO_REQUEST, PRO_COMMON, PRO_QINIU }
// module.exports = {
